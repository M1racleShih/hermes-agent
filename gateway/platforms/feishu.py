...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _build_outbound_payload(self, content: str) -> tuple[str, str]:
        # Feishu post-type 'md' elements support full GFM syntax including tables
        # when sent via the post message type (not interactive cards).
        # Route table content through the same post path instead of downgrading
        # to plain text, which escapes pipes and makes tables unreadable.
        # See: https://github.com/NousResearch/hermes-agent/issues/27529
